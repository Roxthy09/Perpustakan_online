...
<head>
  ...
  <style>
/* Pastikan logo dan ikon memiliki posisi yang benar */
.left-sidebar .brand-logo .logo-full {
    display: block;
    max-width: 130px; /* Sesuaikan jika perlu */
}
.left-sidebar .brand-logo .logo-icon {
    display: none;
    max-width: 40px; /* Sesuaikan jika perlu */
}

/* Aturan utama saat sidebar diminimalkan */
.minimized-sidebar .left-sidebar .brand-logo .logo-full {
    display: none !important;
}

.minimized-sidebar .left-sidebar .brand-logo .logo-icon {
    display: block !important;
    margin: 0 auto; /* Tambahkan ini untuk memastikan ikon di tengah */
}

/* Sembunyikan semua teks menu saat sidebar diminimalkan */
.minimized-sidebar .left-sidebar .hide-menu {
    display: none;
}
...
<body>
  ...
  <div id="main-wrapper">
    ...
    <div class="page-wrapper">
      <!--  Header Start -->
      @include('layouts.components.heade')
      <!--  Header End -->
