          ...
          <div class="row g-0">
            <div class="col-xl-7 col-xxl-8">
              <div class="d-none d-xl-flex align-items-center justify-content-center vh-100">
                <img
                  src="{{asset('admin/assets/images/backgrounds/perpustakaan.png')}}"
                  alt="modernize-img"
                  class="img-fluid w-110 h-100"
            ...
            <div class="col-xl-5 col-xxl-4">
              ...
              >
                <div class="auth-max-width col-sm-8 col-md-6 col-xl-7 px-4">
                  <h2 class="mb-1 fs-7 fw-bolder">Welcome to E-Perpustakaan</h2>
                  <p class="mb-7">Your Master</p>
                  <div class="row">
                    <div class="col-12 mb-2 mb-sm-0 ">
                      ...
                      >
                        <img
                          src="{{asset('admin/assets/images/svgs/google-icon.svg')}}"
                          alt="modernize-img"
                  ...
                  <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                      ...
                      <a
                        ...
                        href="{{asset('admin/main/authentication-register.html')}}"
                        >Create an account</a
                      >
                    </div>
                  </form>
